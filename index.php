            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center animate-fade-in-up">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <a href="login.php" class="bg-gray-100 hover:bg-gray-200 hover:-translate-y-0.5 hover:shadow-lg text-gray-900 px-8 py-3 rounded-lg text-lg font-medium transition-all duration-300">
                            login
                        </a>
                    </div>
                </div>
